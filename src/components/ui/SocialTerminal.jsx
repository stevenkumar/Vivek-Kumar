...
${profile?.bio ? profile.bio.split('\n\n')[0].replace(/\*\*/g, '').replace(/\*/g, '') : 'Passionate about fast, animated, accessible web interfaces.'}`,
        })
        break
...
Fill out the contact form on the right to start building together!`,
  ...
  return (
    <div className="bg-theme-card rounded-[22px] border border-theme hover:border-theme-primary transition-all duration-500 p-6 sm:p-7 shadow-2xl overflow-hidden flex flex-col justify-between">
      ...
      <div className="mb-4">
        <Typography variant="caption" className="text-theme-muted mb-2 font-bold flex items-center gap-1.5">
        ...
        <div className="flex flex-wrap gap-2">
          <Button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 font-mono group"
          >
          ...
          <Button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 font-mono"
          >
          ...
          <Button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 font-mono ml-auto"
      ...
      >
        ...
        <Button
          ...
          className="h-7 w-7 p-1 text-theme-muted hover:text-theme-primary shrink-0"
        >
