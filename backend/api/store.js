...
/**
 * Ensure data and uploads folders exist without crashing startup if the host
 * cannot create them.
 */
const ensureDir = (dir) => {
  try {
 ...
 * Requires a writable filesystem (Render persistent disk, Node VPS, cPanel, or localhost).
 */
